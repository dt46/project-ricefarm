            ...
            <div class="sidebar px-4 py-4 py-md-4 me-0 gradient">
                <div class="d-flex flex-column h-100">
                    ...
                    <ul class="menu-list flex-grow-1 mt-3">
                        <li><a class="m-link active" href="/admin"><i class="icofont-home fs-5"></i><span>Home</span></a>
                        </li>
                        <li><a class="m-link" href="/adminarticles"><i class="icofont-folder fs-5"></i><span>Artikel</span></a></li>
                                ...
                                <div class="container-xxl">
                                    ...
                                    <div class="row g-3 mb-3">
                                        <div class="col-md-12">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="dropdown user-profile ml-2 ml-sm-3 d-flex flex-column zindex-popover">
                                                        <a class="nav-link dropdown-toggle pulse p-0" href="#" role="button" data-bs-toggle="dropdown" data-bs-display="static">
                                                            <img class="avatar lg rounded-circle img-thumbnail" src="{{asset('assets/img/profile_av.svg')}}" alt="profile">
                                                        </a>
                                                        <div class="u-info mt-2">
