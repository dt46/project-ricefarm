                    ...
                    <div class="col-tact-style-one">
                        <div class="contact-form-style-one">
                            ...
                            <div class="row" style="margin-bottom: 5px;">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" id="name" name="name" placeholder="Tanggal" type="date">
                            ...
                            <div class="row" style="margin-bottom: 5px;">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" id="name" name="name" placeholder="Keterangan" type="text">
                                        <span class="alert-error"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="margin-bottom: 5px;">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" id="name" name="name" placeholder="Jumlah Pengeluaran" type="number">
                                        <span class="alert-error"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="margin-bottom: 5px;">
                                <div class="col-lg-12">
                                    <a href="pencatatan.html" style="background-color: #1f4e3d; display: inline-block; padding: 10px 20px; color: #fff; text-decoration: none; border-radius: 4px;">
                                        Simpan
                                    </a>
                                </div>
                            </div>
