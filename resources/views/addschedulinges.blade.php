                    ...
                    <div class="col-tact-style-one">
                        <div class="contact-form-style-one">
                            ...
                            <div class="row" style="margin-bottom: 5px;">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" id="name" name="name" placeholder="Nama penjadwalan" type="text">
                            ...
                            <div class="row" style="margin-bottom: 5px;">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" id="name" name="name" placeholder="Tanggal  mulai" type="date">
                                        <span class="alert-error"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="margin-bottom: 5px;">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" id="name" name="name" placeholder="Jenis padi" type="text">
                                        <span class="alert-error"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="margin-bottom: 5px;">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" id="name" name="name" placeholder="Luas lahan" type="number">
                                        <span class="alert-error"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="margin-bottom: 5px;">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" id="name" name="name" placeholder="Musim" type="text">
                                        <span class="alert-error"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="margin-bottom: 5px;">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" id="name" name="name" placeholder="Catatan" type="text" style="padding-bottom: 100px;">
                                        <span class="alert-error"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="margin-bottom: 5px;">
                                <div class="col-lg-12">
                                    <a href="lihatjadwal.html" style="background-color: #1f4e3d; display: inline-block; padding: 10px 20px; color: #fff; text-decoration: none; border-radius: 4px;">
                                        Simpan
                                    </a>
                                </div>
                            </div>
