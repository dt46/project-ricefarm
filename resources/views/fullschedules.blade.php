...
<head>
    ...
    <!-- CSS -->
    <link href="assets/css/jadwallengkap.css" rel="stylesheet">
        ...
        <div class="container">
            <div class="row">
                <div class="blog-content col-xl-10 offset-xl-1 col-md-12">
                    <div class="blog-item-box" style="background-color: #fff; border-radius: 10px; box-shadow: 5px 5px
                        ...
                        <div class="item">
                            <div class="info" style="margin-top: 5px;">
                                ...
                                <div class="col p-2 mb-2" style="background-color: #F8F8F8; margin-top: 10px; border-radius: 5px;">
                                    Pemberian pestisida & vitamin fase 1 :
                                </div>
                                <div class="col p-2 mb-2" style="background-color: #F8F8F8; margin-top: 10px; border-radius: 5px;">
                                    Pembersihan lahan :
                                </div>
                                <div class="col p-2 mb-2" style="background-color: #F8F8F8; margin-top: 10px; border-radius: 5px;">
                                    Pemberian pestisida & vitamin fase 2 :
                                </div>
                                <div class="col p-2 mb-2" style="background-color: #F8F8F8; margin-top: 10px; border-radius: 5px;">
                                    Pemupukan fase 2 :
                                </div>
                                <div class="col p-2 mb-2" style="background-color: #F8F8F8; margin-top: 10px; border-radius: 5px;">
                                    Pemberian pestisida & vitamin fase 3 :
                                </div>
                                <div class="col p-2 mb-2" style="background-color: #F8F8F8; margin-top: 10px; border-radius: 5px;">
                                    Pemberian pestisida & vitamin fase 4 :
                                </div>
                                <div class="col p-2 mb-2" style="background-color: #F8F8F8; margin-top: 10px; border-radius: 5px;">
                                    Panen :
                                </div>
                                <div class="col p-2 mb-2 " style="background-color: #F8F8F8; margin-top: 10px; border-radius: 5px; height: 150px;">
                                    Catatan :
                                </div>
                                <a class="btn mt-10 btn-md btn-theme animation" href="lihatjadwal.html" style="margin-top: 25px; 
                                    background-color: #1f4e3d; text-align: center;">Kembali</a>
                                <a class="btn mt-10 btn-md btn-theme animation" href="#" style="margin-top: 25px; 
                                    background-color: #b20000; text-align: center; float: right;">Hapus</a>
                            </div>
                        </div>
                    </div>
                </div>
